...
try:
    ...
    from ..utils.platform import get_config_directory, get_platform_info
...
class ConfigPaths:
    ...
    def _use_fallback_paths(self):
        ...
        self.TEMP_DIR = (
            Path("/tmp") / "ashyterm"
            if sys.platform != "win32"
            else home / "AppData" / "Local" / "Temp" / "ashyterm"
        )
        self.LOG_DIR = self.CONFIG_DIR / "logs"
        self.BACKUP_DIR = self.CONFIG_DIR / "backups"
        self.SECURE_DIR = self.CONFIG_DIR / "secure"
...
class DefaultSettings:
    ...
    def get_defaults() -> Dict[str, Any]:
        ...
        return {
            ...
            "default_ssh_port": 22,
            # Window management
            "new_instance_behavior": "new_tab",  # "new_tab" or "new_window"
            # Security settings
...
def initialize_configuration():
    ...
    try:
        ...
        try:
            essential_dirs = [paths.CONFIG_DIR, paths.LOG_DIR, paths.BACKUP_DIR]
